class Slider {
    constructor({
        ...
        let innerSliderWidth = content.length * 100, outerSliderWidth = advanceSetting.sliderWidthPercent

        // Main Section ID for each instance
    ...
    init({
        ...
        page = true,
        pageSetting = {
            active: `<div class="pagination-button pagination-active" style="cursor: pointer; width:30px; height:4px; border-radius:20px; background:#666666; margin:1px"></div>`,
            inactive: `<div class="pagination-button" style="cursor: pointer; width:30px; height:4px; border-radius:20px; background:#CBCBCB; margin:1px"></div>`,
        },
        navSetting = {
            Left: `Left`,
            Right: `Right`,
